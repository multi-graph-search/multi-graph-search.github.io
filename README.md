...
This is the repository that contains the source code for our paper website [_Parallel Heuristic Search as Inference for Actor-Critic Reinforcement Learning Models_](https://p-achs.github.io/).
